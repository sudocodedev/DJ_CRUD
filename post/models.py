...
class UserProfile(models.Model):
    ...
    profileBackground=models.ImageField(upload_to='profile_images/',blank=True, default='defaultBackground.jpg')
    profileImg=models.ImageField(upload_to='profile_images/', blank=True, default='defaultUser.jpg')
...
class post(models.Model):
    ...
    image=models.ImageField(upload_to='posts_images/',blank=True, default='defaultBackground.jpg')
    content=HTMLField()
